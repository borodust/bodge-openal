;; Generated by :claw at 2023-09-15T16:23:53.060420Z
...
(defparameter %al::+eaxreverb-default-air-absorption-gainhf+
  0.9940000176429749d0)
...
(defparameter %al::+max-meters-per-unit+ nil)
...
(defparameter %al::+min-meters-per-unit+ nil)
...
(cffi:defcfun ("alAuxiliaryEffectSlotfv" %al::auxiliary-effect-slotfv)
    %al::void
  (%al::effectslot %al::uint)
  (%al::param %al::enum)
...
(cffi:defcfun ("alAuxiliaryEffectSlotiv" %al::auxiliary-effect-slotiv)
    %al::void
  (%al::effectslot %al::uint)
  (%al::param %al::enum)
...
(cffi:defcfun ("alDeferUpdatesSOFT" %al::defer-updates)
    %al::void)
...
(cffi:defcfun ("alGenAuxiliaryEffectSlots" %al::gen-auxiliary-effect-slots)
    %al::void
  (%al::n %al::sizei)
  (%al::effectslots (claw-utils:claw-pointer %al::uint)))
...
(cffi:defcfun ("alGetAuxiliaryEffectSlotf" %al::get-auxiliary-effect-slotf)
    %al::void
  (%al::effectslot %al::uint)
  (%al::param %al::enum)
...
(cffi:defcfun ("alGetAuxiliaryEffectSlotfv" %al::get-auxiliary-effect-slotfv)
    %al::void
  (%al::effectslot %al::uint)
  (%al::param %al::enum)
  (%al::pfl-values (claw-utils:claw-pointer %al::float)))
...
(cffi:defcfun ("alGetAuxiliaryEffectSloti" %al::get-auxiliary-effect-sloti)
    %al::void
  (%al::effectslot %al::uint)
  (%al::param %al::enum)
...
(cffi:defcfun ("alGetAuxiliaryEffectSlotiv" %al::get-auxiliary-effect-slotiv)
    %al::void
  (%al::effectslot %al::uint)
  (%al::param %al::enum)
  (%al::pi-values (claw-utils:claw-pointer %al::int)))
...
(cffi:defcfun ("alGetError" %al::get-error)
    %al::enum)
...
(cffi:defcfun ("alIsAuxiliaryEffectSlot" %al::is-auxiliary-effect-slot)
    %al::boolean
  (%al::effectslot %al::uint))
...
(cffi:defcfun ("alIsBufferFormatSupportedSOFT" %al::is-buffer-format-supported)
    %al::boolean
  (%al::format %al::enum))
...
(cffi:defcfun ("alProcessUpdatesSOFT" %al::process-updates)
    %al::void)

(cffi:defctype %al::lpalfoldbackcallback (claw-utils:claw-pointer :void))
