;; Generated by :claw at 2023-09-15T16:23:58.339566Z
(uiop:define-package :%alc (:use))
(uiop:define-package :bodge-openal-context-bindings~pristine (:use :cl))
...
(cffi:defcstruct (%alc::device-struct :size 0))

(cffi:defctype %alc::device (:struct %alc::device-struct))
...
(cffi:defcstruct (%alc::context-struct :size 0))

(cffi:defctype %alc::context (:struct %alc::context-struct))
